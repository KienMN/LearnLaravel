...
<head>
    <title>Documentation for Topica.ai</title>
    <!-- Meta -->
    <meta charset="utf-8">
                ...
                <div class="branding">
                    <h1 class="logo">
                        <a href="index.html">
                            ...
                            <span class="text-highlight">TOPICA.AI</span><span class="text-bold">Docs</span>
                        </a>
                    </h1>
                </div><!--//branding-->
                <ol class="breadcrumb">
        ...
        <div class="doc-wrapper">
            <div class="container">
                <div id="doc-header" class="doc-header text-center">
                    <h1 class="doc-title"><i class="icon fa fa-paper-plane"></i> Documents</h1>
                    <div class="meta"><i class="fa fa-clock-o"></i> Last updated: Aug 11, 2017</div>
                </div><!--//doc-header-->
                <div class="doc-body">
                        ...
                        <div class="content-inner">
                            <section id="download-section" class="doc-section">
                                ...
                                <div class="section-block">
                                    ...
                                    <a href="" class="btn btn-green" target="_blank"><i class="fa fa-download"></i> Download Topica.ai Docs</a>
                                </div>
                            </section><!--//doc-section-->
  ...
  return out + &quot;&lt;/ul&gt;&quot;; 
    ...
    <footer id="footer" class="footer text-center">
        <div class="container">
            ...
            <p>Copyright &copy; Topica.ai 2017</p>
